...
use crate::components::business_components::tables::{ColumnsInfoWithEnumDataType, TableInfo};
...
pub type BColumnsInfoWithEnumDataType = ColumnsInfoWithEnumDataType;
